  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-10">
      ...
      <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mb-8">
        <p className="text-sm font-medium text-amber-700 mb-1">Was du bereit haben solltest:</p>
      ...
      <Button
        onClick={() => onNext({})}
        className="w-full bg-rose-500 hover:bg-rose-600 text-white rounded-xl py-6 text-base font-semibold"
      >
        Jetzt starten →
      </Button>
    </div>
